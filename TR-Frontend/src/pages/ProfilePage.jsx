...
const InfoRow = ({ label, value, highlight = false }) => (
  <div className="flex items-center justify-between py-2.5 border-b border-surface-border last:border-0">
    ...
    <span className={`text-[14px] font-black ${highlight ? 'text-brand' : 'text-content-main'}`}>
      {value || '—'}
    </span>
  </div>
);
        ...
        <StaggerContainer key={activeTab}>
            ...
            <>
              ...
              <div className="p-4 bg-surface-level1 border border-surface-border rounded-2xl flex items-center gap-5 shadow-md relative overflow-hidden text-left mb-3">
                ...
                <div className="flex flex-col gap-1 min-w-0">
                  <span className="text-[14px] text-content-muted font-medium leading-normal">
            ...
            <>
              ...
              >
                {isEditPassword ? (
                  ...
                  <div className="text-[14px] font-semibold text-content-muted py-1 leading-relaxed">
                ...
                {isEditPin ? (
                  <form onSubmit={handleSavePin} className="space-y-3 pt-1">
                    <PasswordInputLP
                      ...
                      placeholder="1717"
                    />
                    <ButtonLP type="submit" variant="primary" className="!py-2.5 !h-11 text-[14px]" disabled={pinCode.length !== 4}>
          ...
          <div className="pt-2">
            <button 
              ...
              className="w-full py-3 bg-surface-base text-danger font-bold text-[14px] transition-all rounded-2xl active:scale-[0.98] flex items-center justify-center gap-2"
            >
              Выйти из аккаунта
            </button>
          </div>
