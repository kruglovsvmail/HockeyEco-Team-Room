...
const NOTIFICATION_GROUPS = [
  ...
  { key: 'training_plan', label: 'План тренировки',    icon: 'training_tactics', description: 'Публикация плана упражнений на тренировку' },
    ...
    try {
      ...
      await fetch(`${apiUrl}/api/push/settings`, {
        ...
        body: JSON.stringify({
          ...
          lines: updated.lines,
          training_plan: updated.training_plan,
