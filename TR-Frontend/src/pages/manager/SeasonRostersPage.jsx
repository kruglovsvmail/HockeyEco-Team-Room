  ...
  if (!hasAccess) {
    return (
      <SubscriptionStub 
        ...
        description="Для просмотра и управления заявками, дозаявками и отзаявками хоккеистов в официальные дивизионы лиг, необходимо оформить или продлить подписку."
      />
    );
  }

  return (
    <div className="flex flex-col h-full px-3 pt-6 bg-surface-base overflow-y-auto scrollbar-hide transition-colors duration-300">
      <div className="shrink-0 mb-4 text-left">
        <h1 className="text-[28px] font-black uppercase tracking-widest text-content-main">
          Заявки на сезон
        </h1>
        {selectedTeam && (
          <p className="text-[14px] font-bold text-brand uppercase tracking-wider mt-1">
