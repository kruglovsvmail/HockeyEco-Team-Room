...
export function ButtonLP({ 
  ...
  const baseStyles = "relative w-full flex items-center justify-center uppercase tracking-widest rounded-2xl overflow-hidden transition-all duration-300 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed outline-none";

  // Специфичные стили для каждого варианта
  const variants = {
    primary: clsx(
      "py-4 font-bold text-sm",
      "bg-gradient-to-r from-brand-dark to-brand text-surface-base shadow-brand-glow",
