  ...
  return (
    <div
      className={clsx(
        ...
        "bg-surface-level1 rounded-2xl p-3 flex flex-col relative z-0 shadow-md overflow-hidden w-full transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]",
        className
      )}
      {...props}
    >
