  ...
  return (
    <div className={clsx("flex-1 flex flex-col items-center justify-center h-full w-full min-h-[200px] bg-transparent select-none", className)}>
      <div className="relative flex items-center justify-center">
        ...
        <div className="w-9 h-9 rounded-full border-2 border-surface-border/40 border-t-brand animate-spin" />
...
export function Skeleton({ className, variant = 'rect' }) {
  return (
    <div 
      className={clsx(
        "animate-pulse bg-surface-level3/50 border border-surface-border/10",
...
export function SkeletonCard({ className }) {
  return (
    <div className={clsx("p-4 bg-surface-level2/40 border border-surface-border/30 rounded-2xl flex flex-col gap-3 w-full box-border", className)}>
