...
export function SubscriptionStub({ 
  ...
  return (
    <div
      className={clsx(
        "absolute inset-0 z-[999] flex flex-col w-full h-full bg-surface-base transition-transform duration-500",
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center bg-gradient-to-b from-surface-base via-surface-level1/30 to-surface-base">
        ...
        <h2 className="text-[18px] font-extrabold text-content-main tracking-tight mb-3 px-4">
          {title}
        </h2>
      ...
      <footer className="h-8 bg-surface-base shrink-0 border-t border-surface-border flex items-center justify-center opacity-40">
        <span className="text-[10px] font-medium text-content-muted tracking-wider">
