...
export function EventFilters({ user, teams = [], onClose }) {
  ...
  return (
    <div className="p-4 text-left">
      <h2 className="text-[18px] font-black text-content-main">Фильтр событий</h2>
                ...
                return (
                  ...
                  >
                    ...
                    {team.logo_url ? (
                      ...
                      <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-surface-level3  text-content-muted font-black text-[10px] uppercase tracking-wider shrink-0">
                        {team.short_name || 'Т'}
                      </div>
                    )}
