  ...
  return (
    ...
    <div className="w-full bg-surface-level1/50 backdrop-blur-sheet rounded-2xl overflow-hidden mb-4 flex flex-col">
      ...
      <div className="w-full bg-transparent p-3 flex flex-col justify-between">
        ...
        {/* Верхняя часть */}
        <div className="flex items-center justify-between text-[12px] font-medium italic text-content-muted tracking-wide uppercase mb-2">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-[24px] font-black text-content-main uppercase tracking-wide">
            МАТЧ
          </span>
        ...
        {/* Нижняя (третья) часть */}
        <div className="flex items-center justify-between text-[10px] font-normal text-content-muted/80 uppercase tracking-wider mb-[-8px]">
          <span>
      ...
      <div className="w-full bg-surface-level1/50 flex items-stretch px-2 py-4">
        
        {/* Левая часть: Хозяева */}
        <div className="flex-1 flex flex-col items-center justify-start gap-2">
          {/* Верхняя (Логотип) */}
          <div className="w-10 h-10 bg-surface-base border border-surface-border/40 p-0.5 rounded-lg flex items-center justify-center">
            {event.home_logo ? (
          ...
          {/* Нижняя (Название) */}
          <span className="text-[12px] font-bold text-content-main uppercase text-center leading-tight tracking-wide">
            {event.home_name}
          </span>
        </div>

        {/* Центральная часть: Счет и Стадия */}
        <div className="flex-1 flex flex-col items-center justify-center px-2  mb-2">
          {/* Верхняя (Счет) */}
          <div className="flex items-center justify-center gap-1 text-[28px] font-black text-content-main font-mono mb-2">
        ...
        <div className="flex flex-col items-center text-[10px] uppercase tracking-wide text-content-muted/80 text-center leading-tight">
        ...
        <div className="flex-1 flex flex-col items-center justify-start gap-2">
          ...
          {/* Нижняя (Название) */}
          <span className="text-[12px] font-bold text-content-main uppercase text-center leading-tight tracking-widest">
            {event.away_name}
          </span>
        </div>
