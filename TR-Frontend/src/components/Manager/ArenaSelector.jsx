              ...
              arenas.map(arena => (
                ...
                >
                  <div className="flex flex-col min-w-0 pr-2 text-left">
                    <span className="text-[14px] font-bold text-content-main truncate">{arena.name}</span>
                    <span className="text-[10px] text-content-muted mt-0.5 truncate">{arena.city}, {arena.address}</span>
                  </div>
