...
function TeamLayoutContent() {
  ...
  const basePath = eventMatch ? '/' : location.pathname;
  useEffect(() => {
    closeRightPanel();
  ...
  return (
    <div className="flex flex-col w-full h-full overflow-hidden relative">
      ...
      <div className={clsx(
        ...
        eventMatch && eventForOverlay ? "-translate-x-full" : ""
      )}>
        <Header
      ...
      {/* Правая панель: выезжает справа внутри 1000px-контейнера.
          eventEdit поднят над EventPage-overlay (z-100). */}
      <div className={clsx(
        ...
        "transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]",
        rightPanel.type === 'eventEdit' ? "z-[110]" : "z-[40]",
      ...
      {/* Click-zone слева для закрытия панели редактирования, когда поверх лежит EventPage.
          z-[105] — выше EventPage (z-100), но ниже самой панели (z-110). */}
      {rightPanel.isOpen && rightPanel.type === 'eventEdit' && eventForOverlay && (
        <div
