...
//
// Упражнение принадлежит человеку, а не команде, клубу или сообществу: тренер работает
// с разными составами, меняет клубы, и его методика уходит вместе с ним. Поэтому во всех
// ручках ниже владелец — req.user.id, и чужую строку не отдаст и не тронет ни одна из них.
//
 ...
 */
// Где живут планы: таблица пунктов, колонка, которой пункт ссылается на тренировку, и сама
// тренировка — по её дате делятся прошедшие и предстоящие. Контекстов три — команда, клуб
// и сообщество, те же, что выбирает planTarget() в TrainingPlanController.js. Контекст,
// забытый здесь, молча выпадает из заморозки, переименования и снятия упражнения: так было
// с сообществом — его прошедшие тренировки показывали исправленное упражнение, а
// предстоящие держали удалённое.
const PLAN_SCOPES = [
  ['team_training_plan', 'team_training_id', 'team_training'],
  ['club_training_plan', 'club_training_id', 'club_training'],
  ['community_training_plan', 'community_training_id', 'community_training'],
];
