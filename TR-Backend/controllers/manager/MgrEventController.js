  ...
  try {
    ...
    if (eventType === 'match') {
      ...
      const result = await pool.query(insertGameQuery, [
        ...
        // (friendly_pwa, friendly_ext или tournament_ext). Раньше поле проставлялось
        // только для friendly_pwa, из-за чего для friendly_ext/tournament_ext
        // MatchProtocol.isInitiator и backend assertEditable никогда не признавали
        // организатора владельцем матча — ввод хода игры и статистики был недоступен.
        teamId,
        arenaTz, // $19
        customTz, // $20
        locationName, // $21
